...
// AprilSDK
#define COCOAPODS_POD_AVAILABLE_AprilSDK
#define COCOAPODS_VERSION_MAJOR_AprilSDK 1
#define COCOAPODS_VERSION_MINOR_AprilSDK 3
#define COCOAPODS_VERSION_PATCH_AprilSDK 1
